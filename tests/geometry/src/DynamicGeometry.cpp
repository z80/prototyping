...
void DynamicGeometry::initCustomGeometry()
{
    ...
    cg->DefineVertex( Vector3( 0.0f, 0.0f, 0.0f ) );
    cg->DefineColor( Color( 1.0, 0.0, 0.0 ) );
    cg->DefineNormal( Vector3( 0.0f, -1.0f, 0.0f ) );

    cg->DefineVertex( Vector3( 10.0f, 0.0f, 0.0f ) );
    cg->DefineColor( Color( 0.0, 1.0, 0.0 ) );
    cg->DefineNormal( Vector3( 0.0f, -1.0f, 0.0f ) );

    cg->DefineVertex( Vector3( 10.0f, 0.0f, 10.0f ) );
    ...
    Node * nl = scene_->CreateChild( "PointLight" );
    nl->SetPosition( Vector3( 0.0f, 5.0f, 0.0f ) );
    Light * l = nl->CreateComponent<Light>();
